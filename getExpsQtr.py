...
# getExpsQtr.py -- get all the required Expense totals for a particular Quarter
#
...
EXP_ACCTS = {
    "Balance"    : ["EXP_Balance"],
    "Contingent" : ["EXP_CONTINGENT"],
    "Necessary"  : ["EXP_NECESSARY"],
    "Sal_Dedns"  : ["EXP_Salary"]
}
...
def get_exps_qtr_main():
    ...
    try:
        ...
        print("find Expenses in {} for {}-Q{}".format(gnucash_file, str_year, str_quarter))
